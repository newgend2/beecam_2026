    ...
    def __init__(self, coords, category, conf, metadata):
        ...
        try:
            ...
            if "stream" not in str(e):
                raise
            # Older Picamera2 releases only convert to the main stream. In v2
            # main is full-res, so convert back to preview/lores coordinates.
...
def capture_still(stem: str, detections=None, request=None):
    ...
    try:
        ...
        if request is not None:
            ...
            raise RuntimeError("Model captures require a completed request in v2")
...
def main():
    ...
    try:
        ...
        print("beecam_capture_v2 started")
        ...
        while True:
            ...
            try:
                ...
                if detections and has_current_inference:
                    if capture_full_res_image(detections, request, metadata):
                        fps_queued_count += 1
